...
Per ciascuna iterazione con il costrutto condizionale \key{if} incrementiamo un
contatore solo se l'elemento della tabella è pari. L'\key{if} ha anch'esso
...
L'operatore \texttt{\#} restituisce la lunghezza di una tabella array come uno
dei sui \emph{bordi}. Un bordo è la posizione di un valore non \key{nil} seguito
da un valore \key{nil}, oppure zero se la posizione 1 è \key{nil}.
