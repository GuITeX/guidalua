...
\key{...} tre caratteri punto consecutivi\footnote{Questa caratteristica è
...
La funzione predefinita \fn{select} consente di accedere alla lista degli
...
nulli seguite da valori \key{nil} (maggiori dettagli alla sezione \S
