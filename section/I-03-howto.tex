...
vostra personale soluzione è: \VerbatimInput{app-start/E1-001-fattoriale.tex}
...
\VerbatimInput{app-start/E1-003-fattoriale.tex}
...
\item \code{lpeg}, parsing di grammatiche da testo semplice.
\end{compactitemize}
