...
iniziare subito con Lua e comprendere come eseguirne il codice all'interno del
sorgente (La)\TeX{}, dal capitolo~\ref{iChStart}.

La seconda parte tratta delle basi del linguaggio Lua e contiene numerosi
esercizi, dal capitolo~\ref{iiChEseguireEsercizi}.

La terza parte presenta le tecnologie Lua specifiche dei compositori della
moderna generazione, in particolare quella dei nodi (dal
capitolo~\ref{iiiChNodi}).
