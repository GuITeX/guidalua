...
la libreria \code{node} che rende possibile la costruzione delle strutture
tipografiche dei nodi in Lua.

Grazie alla libreria \code{node} è possibile costruire ogni tipo di struttura
...
La destinazione deve essere unica. Riutilizzare un oggetto nodo già finalizzato
...
funzione \fn{node.write}\luastd{node.write}. L'importante è che lo stesso nodo
...
% alcuni singoli nodi/presentazione
...
Il nodo rule è l'equivalente della macro \cs{rule}. L'altezza totale è la somma
